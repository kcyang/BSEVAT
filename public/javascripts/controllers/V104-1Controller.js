...
'use strict';
/* global angular */
angular.module('V104-1Ctrl',['ngGrid'])
    .controller('V104-1Controller',function($scope,$log,$window,VATService,$location,$route,ngDialog){

    //# 상수정의.
    $scope.constants = {
        'VATNO' : 'V104-1',  //이 화면의 VAT 번호.
        'EMPTY' : 'true'
    };
    ...
    $scope.getExcel = function(){
        ...
        VATService.update($scope.constants.VATNO,$scope.mg,function(err,data){
            ...
            VATService.excel($scope.VATROOTKEY[0],function(err,data){
                 ...
                 *
                 */
                saveAs(new Blob([data],{type:"application/vnd.ms-excel;charset=euc-kr"}), "매출처별 계산서 합계표.xlsx");
