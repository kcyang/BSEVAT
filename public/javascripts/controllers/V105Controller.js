...
'use strict';
/* global angular */
angular.module('V105Ctrl',['ngGrid'])
    .controller('V105Controller',function($scope,$log,$window,VATService,$location,$route,ngDialog){

    //# 상수정의.
    $scope.constants = {
        'VATNO' : 'V105',  //이 화면의 VAT 번호.
        'EMPTY' : 'true'
    };
    ...
    $scope.calc = function(){
        ...
        $scope.mg.ELEC_TOT_PURCH_TAX_AMT = Number($scope.mg.ELEC_BUS_PURCH_TAX_AMT) + Number($scope.mg.ELEC_PSN_PURCH_TAX_AMT);
        ...
        $scope.mg.NON_ELEC_TOT_PURCH_TAX_AMT = Number($scope.mg.NON_ELEC_BUS_PURCH_TAX_AMT) + Number($scope.mg.NON_ELEC_PSN_PURCH_TAX_AMT);
