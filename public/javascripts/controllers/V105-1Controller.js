...
'use strict';
/* global angular */
angular.module('V105-1Ctrl',['ngGrid'])
    .controller('V105-1Controller',function($scope,$log,$window,VATService,$location,$route,ngDialog){

    //# 상수정의.
    $scope.constants = {
        'VATNO' : 'V105-1',  //이 화면의 VAT 번호.
        'EMPTY' : 'true'
    };
