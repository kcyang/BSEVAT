                        ...
                        MODEL.aggregate()
                            .match({
                                ...
                                { $in : ["P220","P230","P240","P251","P252","P253","P254","P261","P262"
                                    ,"P331","P332","P333","P334","P341","P342","P343","P344"]}
                            })
                            .group({
                                _id: "",
                                TotAmount: {  //공급가액
                            ...
                            .exec(function(err,res){
                                ...
                                if(err){
                                    ...
                                    if(res.length !== 0) {
                                        ...
                                        CALC['CASH_COUNT'] = res[0].numCnt;
                                        CALC['CASH_AMOUNT_TOTAL'] = res[0].TotAmount;
                                        CALC['CASH_TAX_TOTAL'] = res[0].VatAmount;
                                    }
                                }
                            ...
                            .exec(function(err,res){
                                ...
                                if(err){
                                    ...
                                    if(res.length !== 0) {
                                        ...
                                        CALC['CARD_COUNT'] = res[0].numCnt;
                                        CALC['CARD_AMOUNT_TOTAL'] = res[0].TotAmount;
                                        CALC['CARD_TAX_TOTAL'] = res[0].VatAmount;
                                    }
                                }
                                innerCallback(null,false);
                            });
