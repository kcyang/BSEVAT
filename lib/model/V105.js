 ...
 */
var CALC = {
    "ELEC_BUS_PURCH_CNT" : 0,
    "ELEC_BUS_PURCH_QTY" : 0,
    "ELEC_BUS_PURCH_ACT_AMT" : 0,
    "ELEC_BUS_PURCH_TAX_AMT" : 0,

    "ELEC_PSN_PURCH_CNT" : 0,
    "ELEC_PSN_PURCH_QTY" : 0,
    "ELEC_PSN_PURCH_ACT_AMT" : 0,
    "ELEC_PSN_PURCH_TAX_AMT" : 0,

    "NON_ELEC_BUS_PURCH_CNT" : 0,
    "NON_ELEC_BUS_PURCH_QTY" : 0,
    "NON_ELEC_BUS_PURCH_ACT_AMT" : 0,
    "NON_ELEC_BUS_PURCH_TAX_AMT" : 0,

    "NON_ELEC_PSN_PURCH_CNT" : 0,
    "NON_ELEC_PSN_PURCH_QTY" : 0,
    "NON_ELEC_PSN_PURCH_ACT_AMT" : 0,
    "NON_ELEC_PSN_PURCH_TAX_AMT" : 0
};
var SUB_ARR = {};
var CALC_SUB = [];
                            ...
                            .exec(function(err,res){
                                ...
                                if(err){
                                    ...
                                    if(res.length !== 0) {
                                        ...
                                        CALC['ELEC_BUS_PURCH_TAX_AMT'] = res[0].VatAmount;
                                    }
                                }
                            ...
                            .exec(function(err,res){
                                ...
                                if(err){
                                    ...
                                    if(res.length !== 0) {
                                        ...
                                        CALC['ELEC_PSN_PURCH_TAX_AMT'] = res[0].VatAmount;
                                    }
                                }
                                innerCallback(null,false);
                            });
                            ...
                            .exec(function(err,res){
                                ...
                                if(err){
                                    ...
                                    if(res.length !== 0) {
                                        ...
                                        CALC['NON_ELEC_BUS_PURCH_TAX_AMT'] = res[0].VatAmount;
                                    }
                                }
                                innerCallback(null,false);
                            });
                            ...
                            .exec(function(err,res){
                                ...
                                if(err){
                                    ...
                                    if(res.length !== 0) {
                                        ...
                                        CALC['NON_ELEC_PSN_PURCH_TAX_AMT'] = res[0].VatAmount;
                                    }
                                }
                                innerCallback(null,false);
                            });
