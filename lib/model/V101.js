...
exports.setValue = function(VATNO,VATROOTKEY,callback){
    ...
    if(VATNO === 'undefined' || VATNO === null){
        ...
        var keyRefV112 = {
            VATKEY : VATROOTKEY.YEAR+VATROOTKEY.VATQT+VATROOTKEY.VATTYPE+'V112'
        };
        var keyRefV164 = {
            VATKEY : VATROOTKEY.YEAR+VATROOTKEY.VATQT+VATROOTKEY.VATTYPE+'V164'
        };
        var keyRefV153 = {
            VATKEY : VATROOTKEY.YEAR+VATROOTKEY.VATQT+VATROOTKEY.VATTYPE+'V153'
        };
    /**
     *{name: '1기 예정', value: '11'},
     ...
     */
        ...
        async.parallel([
                ...
                function(innerCallback){
                    ...
                    mongoModel.findOne({ VATKEY: keyRefV112 }, function (err, result_document) {
                 ...
                 */
                    ...
                    mongoModel.findOne({ VATKEY: keyRefV164 }, function (err, result_document) {
                 ...
                 */
                    ...
                    mongoModel.findOne({ VATKEY: keyRefV153 }, function (err, result_document) {
