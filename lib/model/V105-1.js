                    ...
                    MODEL.find({},function(err){
                        ...
                        MODEL.aggregate()
                            .match({
                                ...
                                "BSE_ETAX Complete issue": 1      //전자계산서 발급분 (발행완료)
                            })
                            .group({
                                _id: "",
                                TotAmount: {  //공급가액
                            ...
                            .exec(function(err,res){
                                ...
                                if(err){
                                    ...
                                    if(res.length !== 0) {
                                        console.error('전자계산서 발급분 매수[%d]',res[0].numCnt);
                                        CALC['ELEC_BUS_PURCH_QTY'] = res[0].numCnt;
                                        CALC['ELEC_BUS_PURCH_ACT_AMT'] = res[0].TotAmount;
                        ...
                        MODEL.aggregate()
                            ...
                            .exec(function(err,res){
                                ...
                                if(err){
                                    ...
                                    if(res.length !== 0) {
                                        console.error('전자계산서 발급분 매출처수 [%d]',res[0].numCnt);
                                        CALC['ELEC_BUS_PURCH_CNT'] = res[0].numCnt;
                                    }
                                }
                                innerCallback(null,false);
                            });
                        ...
                        MODEL.aggregate()
                            ...
                            .exec(function(err,res){
                                ...
                                if(err){
                                    ...
                                    if(res.length !== 0) {
                                        console.error('전자계산서 발급분 주민번호분 매수[%d]',res[0].numCnt);
                                        CALC['ELEC_PSN_PURCH_QTY'] = res[0].numCnt;
                                        CALC['ELEC_PSN_PURCH_ACT_AMT'] = res[0].TotAmount;
                        ...
                        MODEL.aggregate()
                            ...
                            .exec(function(err,res){
                                ...
                                if(err){
                                    ...
                                    if(res.length !== 0) {
                                        console.error('전자계산서 발급분 주민 등록번호 매입처수 [%d]',res[0].numCnt);
                                        CALC['ELEC_PSN_PURCH_CNT'] = res[0].numCnt;
                                    }
                                }
                                innerCallback(null,false);
                            });
                        ...
                        MODEL.aggregate()
                            ...
                            .exec(function(err,res){
                                ...
                                if(err){
                                    ...
                                    if(res.length !== 0) {
                                        console.error('전자계산서 외 발급분 사업자 등록번호 매수[%d]',res[0].numCnt);
                                        CALC['NON_ELEC_BUS_PURCH_QTY'] = res[0].numCnt;
                                        CALC['NON_ELEC_BUS_PURCH_ACT_AMT'] = res[0].TotAmount;
                        ...
                        MODEL.aggregate()
                            ...
                            .exec(function(err,res){
                                ...
                                if(err){
                                    ...
                                    if(res.length !== 0) {
                                        console.error('전자계산서 외 발급분 사업자 등록번호 매입처수 [%d]',res[0].numCnt);
                                        CALC['NON_ELEC_BUS_PURCH_CNT'] = res[0].numCnt;
                                    }
                                }
                                innerCallback(null,false);
                            });
                        ...
                        MODEL.aggregate()
                            ...
                            .exec(function(err,res){
                                ...
                                if(err){
                                    ...
                                    if(res.length !== 0) {
                                        console.error('전자계산서 외 주민 등록번호 발급분[%d]',res[0].numCnt);
                                        CALC['NON_ELEC_PSN_PURCH_QTY'] = res[0].numCnt;
                                        CALC['NON_ELEC_PSN_PURCH_ACT_AMT'] = res[0].TotAmount;
                        ...
                        MODEL.aggregate()
                            ...
                            .exec(function(err,res){
                                ...
                                if(err){
                                    ...
                                    if(res.length !== 0) {
                                        console.error('전자계산서 외 주민등록번호 발급분 매입처수 [%d]',res[0].numCnt);
                                        CALC['NON_ELEC_PSN_PURCH_CNT'] = res[0].numCnt;
                                    }
                                }
                                innerCallback(null,false);
                            });
                        ...
                        MODEL.aggregate()
                            ...
                            .exec(function(err,res){
                                ...
                                if(err){
                                    ...
                                    if(res.length !== 0) {
                                        console.error('전자계산서 외 상세[%d]',res.length);
                                        for(var i in res){
