...
exports.query = function(VAT_NO,CONFIG,callback){
    ...
    if(VAT_NO === null || typeof VAT_NO === 'undefined' || typeof VAT_NO !== 'string'){
        ...
        var company_name = CONFIG.servers.nav.company;
        var vat_table_name = CONFIG.servers.nav.vat_table;
    ...
    //                console.log('가져올 쿼리필드 ['+entries_string+']');
    ...
    //                console.log('조건문에 대한 결과 >>'+condition_string);
                    ...
                    query_string += ' FROM [';
//                    query_string += 'KMX LIVE$'; //company_name
