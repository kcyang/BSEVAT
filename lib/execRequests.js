...
/* Excel 만들기 */
         ...
         * @param 2: template 엑셀 파일 Fullpath + name
         * @param 3: result path
         * @param 4: collection name
         * @param 5: document key
         */

        var src = spawn('python',[path.join(__dirname,'/py/buildExcel.py'),template,serverConfig.excel.result_path,criteria.VATKEY,KEY]);
